...
class HaxeLexer(ExtendedRegexLexer):
    ...
    # combined id and dollar and idtype
    ...
    tokens = {
        ...
        'meta': [
            include('spaces'),
            (r'@', Name.Decorator, ('meta-body', 'meta-id', 'meta-colon')),
        ],
        ...
        # same as 'id' but set token as Name.Decorator instead of Name
        'meta-id': [
            include('spaces'),
        ...
        'object': [
            include('spaces'),
            (r'\}', Punctuation, '#pop'),
            default(('#pop', 'object-sep', 'expr', 'colon', 'id-or-string'))
        ],
